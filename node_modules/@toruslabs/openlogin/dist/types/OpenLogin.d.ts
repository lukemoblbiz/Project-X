import { BaseRedirectParams, LoginParams, ManageMFAParams, OpenLoginOptions, OpenloginSessionConfig, OpenloginSessionData, OpenloginUserInfo, SocialMfaModParams } from "@toruslabs/openlogin-utils";
declare class OpenLogin {
    ...
    manageMFA(params: Partial<ManageMFAParams>): Promise<void>;
